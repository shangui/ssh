...
public class HttpUtil {
	 ...
	 */
	public static Map<String, String> sendPostRequest(String reqURL,
			Map<String, String> reqParams, String reqCharset) {
	...
	public static Map<String, String> sendPostRequest(String reqURL,
		...
		try {
			...
			reqMsg.append("Content-Length: ").append(reqData.getBytes().length)
					.append("\r\n");
			reqMsg.append("\r\n");
			...
			for (int i = 0; i < respBuffer.length; i++) {
				...
				if (from > 0 && to == 0 && respBuffer[i] == 13
						&& respBuffer[i + 1] == 10) {
			...
			if (contentType.toLowerCase().contains("charset")) {
				respCharset = contentType.substring(contentType
						.lastIndexOf("=") + 1);
			}
			/**
			 * 解码HTTP响应的完整报文
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, String> respMap = sendPostRequest(
				"http://127.0.0.1/tra/trade/noCardNoPassword.htm", params,
				"GB18030");
		System.out
				.println("=============================================================================");
